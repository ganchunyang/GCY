...
!function (t, e) {
    ...
    return function (t) {
        ...
        s.VERSION = "2.4.2", s.support = {}, s.support.transition = function () {
            ...
            i = i || {}, n.fn[t] = function (o) {
                var a, r = Array.prototype.slice.call(arguments, 0), l = r.slice(1), c = this.each(function () {
                    var c = n(this), u = "amui." + t, h = i.dataOptions || "data-am-" + t, d = c.data(u),
            ...
            return i.cache[t] || (i.cache[t] = function () {
                var e = t, n = /^[\w\-]+$/.test(t) ? i.get(t) : (e = "template(string)", t), s = 1,
        ...
        function S(t, e, i) {
            var n = i.pointers.length, s = i.changedPointers.length, o = e & St && n - s === 0,
                a = e & (Dt | Ft) && n - s === 0;
        ...
        var rt = i(1), lt = i(2), ct = ["", "webkit", "moz", "MS", "ms", "o"], ut = document.createElement("div"),
            ht = "function", dt = Math.round, pt = Math.abs, mt = Date.now, ft = 1,
            vt = /mobile|tablet|ip(ad|hone|od)|android/i, gt = "ontouchstart" in window,
            wt = void 0 !== b(window, "PointerEvent"), yt = gt && vt.test(navigator.userAgent), bt = "touch",
            Tt = "pen", xt = "mouse", Ct = "kinect", Et = 25, St = 1, kt = 2, Dt = 4, Ft = 8, At = 1, $t = 2, Mt = 4,
            Pt = 8, Nt = 16, It = $t | Mt, Lt = Pt | Nt, Ot = It | Lt, _t = ["x", "y"], zt = ["clientX", "clientY"];
        C.prototype = {
            handler: function () {
            }, init: function () {
        ...
        var Ht = {pointerdown: St, pointermove: kt, pointerup: Dt, pointercancel: Ft, pointerout: Ft},
            Bt = {2: bt, 3: Tt, 4: xt, 5: Ct}, Ut = "pointerdown", Vt = "pointermove pointerup pointercancel";
        window.MSPointerEvent && (Ut = "MSPointerDown", Vt = "MSPointerMove MSPointerUp MSPointerCancel"), l(z, C, {
            handler: function (t) {
                var e = this.store, i = !1, n = t.type.toLowerCase().replace("ms", ""), s = Ht[n],
                    o = Bt[t.pointerType] || t.pointerType, a = o == bt, r = g(e, t.pointerId, "pointerId");
        ...
        var Xt = {touchstart: St, touchmove: kt, touchend: Dt, touchcancel: Ft}, Yt = "touchstart",
        ...
        var Zt = {touchstart: St, touchmove: kt, touchend: Dt, touchcancel: Ft},
        ...
        var Jt = b(ut.style, "touchAction"), Kt = void 0 !== Jt, Qt = "compute", te = "auto", ee = "manipulation",
            ie = "none", ne = "pan-x", se = "pan-y";
        U.prototype = {
            set: function (t) {
        ...
        X.prototype = {
            ...
            defaults: {event: "press", pointers: 1, time: 500, threshold: 5}, getTouchAction: function () {
                ...
                var e = this.options, i = t.pointers.length === e.pointers, s = t.distance < e.threshold,
        ...
        o.DEFAULTS = {
            ...
            var i = this.$element, o = "disabled", a = i.data(), r = this.options, l = i.is("input") ? "val" : "html",
        ...
        function n(t) {
            return this.each(function () {
                var e = s(this), i = e.data("amui.collapse"),
        ...
        a.DEFAULTS = {toggle: !0}, a.prototype.open = function () {
            ...
            var e, i = s(this), a = o.utils.options(i.attr("data-am-collapse")),
                r = a.target || t.preventDefault() || (e = i.attr("href")) && e.replace(/.*(?=#[^\s]+$)/, ""), l = s(r),
                c = l.data("amui.collapse"), u = c ? "toggle" : a, h = a.parent, d = h && s(h);
        ...
        a.DEFAULTS = {
            ...
            var t = this.component ? this.component.offset() : this.$element.offset(),
                ...
                n = t.left, s = o.width() - t.left - e, a = this.isOutView();
            ...
            var t = new Date(this.viewDate), e = t.getFullYear(), i = t.getMonth(), n = this.date.valueOf(),
                s = new Date(e, i - 1, 28, 0, 0, 0, 0), o = r.getDaysInMonth(s.getFullYear(), s.getMonth()),
                l = this.$picker.find(".am-datepicker-days .am-datepicker-select");
            l.text("zh_CN" === this.language ? e + a.locales[this.language].year[0] + " " + a.locales[this.language].months[i] : a.locales[this.language].months[i] + " " + e), s.setDate(o), s.setDate(o - (s.getDay() - this.weekStart + 7) % 7);
            var c = new Date(s);
            ...
            var e, i, s = this.$picker.find(".am-datepicker-days").find(".am-active"),
                o = this.$picker.find(".am-datepicker-months"), a = o.find(".am-active").index(),
        ...
        a.DEFAULTS = {
            ...
            if (this.$dropdown.length) {
                var t = this.$dropdown, e = t.offset(), i = t.outerWidth(), s = this.$boundary.width(),
        ...
        (function (e) {
            ...
            n.flexslider = function (t, i) {
                ...
                var o, a = s.vars.namespace,
                    ...
                    c = "click touchend MSPointerUp keyup", u = "", h = "vertical" === s.vars.direction,
                    d = s.vars.reverse, p = s.vars.itemWidth > 0, m = "fade" === s.vars.animation,
                    f = "" !== s.vars.asNavFor, v = {}, g = !0;
                n.data(t, "flexslider", s), v = {
                    init: function () {
                        ...
                        }), s.vars.pauseInvisible && v.pauseInvisible.isHidden() || (s.vars.initDelay > 0 ? s.startTimeout = setTimeout(s.play, s.vars.initDelay) : s.play())), f && v.asNav.setup(), l && s.vars.touch && v.touch(),
                        (!m || m && s.vars.smoothHeight) && n(window).bind("resize orientationchange focus", v.resize), s.find("img").attr("draggable", "false"), setTimeout(function () {
                            s.vars.start(s)
                        }, 200)
                    }, asNav: {
                        setup: function () {
                        ...
                        setup: function () {
                            ...
                            s.controlsContainer ? (n(s.controlsContainer).append(t), s.directionNav = n("." + a + "direction-nav li a", s.controlsContainer)) : (s.append(t), s.directionNav = n("." + a + "direction-nav li a", s)), v.directionNav.update(), s.directionNav.bind(c, function (t) {
                                t.preventDefault();
                                var e;
                                ("" === u || u === t.type) && (e = s.getTarget(n(this).hasClass(a + "next") ? "next" : "prev"), s.flexAnimate(e, s.vars.pauseOnAction)), "" === u && (u = t.type), v.setToClearWatchedEvent()
                            })
                        }, update: function () {
                            var t = a + "disabled";
                        ...
                        function o(e) {
                            if (t.removeEventListener("touchmove", n, !1), s.animatingTo === s.currentSlide && !b && null !== w) {
                                var i = d ? -w : w, a = s.getTarget(i > 0 ? "next" : "prev");
                        ...
                        function c(t) {
                            ...
                            if (e) {
                                if (e.animatingTo === e.currentSlide && !b && null !== w) {
                                    var i = d ? -w : w, n = e.getTarget(i > 0 ? "next" : "prev");
        ...
        n.prototype = {
            version: "5.1.3", _init: function () {
                ...
                if (this.enabled && a.eventType[t.type] === this.initiated) {
                    ...
                    var e, i, n, s, o = t.touches ? t.touches[0] : t, r = o.pageX - this.pointX,
                        l = o.pageY - this.pointY, c = a.getTime();
                ...
                if (this.enabled && a.eventType[t.type] === this.initiated) {
                    ...
                    var e, i, n = (t.changedTouches ? t.changedTouches[0] : t, a.getTime() - this.startTime),
                        s = Math.round(this.x), o = Math.round(this.y), r = Math.abs(s - this.startX),
                        l = Math.abs(o - this.startY), c = 0, u = "";
        ...
        c.DEFAULTS = {
            ...
            var e = this.$element, i = this.options, n = this.isPopup, o = i.width, r = i.height, c = {};
            ...
            if (this.active) {
                ...
                this.transitioning && (clearTimeout(e.transitionEndTimmer), e.transitionEndTimmer = null, e.trigger(i.transitionEnd).off(i.transitionEnd), a.close(e, !0)), this.$element.trigger(s.Event("close.modal.amui", {relatedTarget: t})), this.transitioning = 1;
                var o = function () {
            ...
            var t = this.options, e = this, i = this.$element, n = i.find(".am-modal-prompt-input"),
                o = i.find("[data-am-modal-confirm]"), r = i.find("[data-am-modal-cancel]"), l = function () {
                    var t = [];
            ...
            var t = s(this), e = o.utils.parseOptions(t.attr("data-am-modal")),
        ...
        c.DEFAULTS = {duration: 300, effect: "overlay"}, c.prototype.open = function (t) {
            ...
            if (i.length && !i.hasClass("am-active")) {
                var n = this.options.effect, o = s("html"), l = s("body"), c = i.find(".am-offcanvas-bar").first(),
            ...
            t.preventDefault();
            var e = s(this), i = o.utils.parseOptions(e.data("amOffcanvas")),
            ...
            e.prototype = {
                defaults: {
                    ...
                    var e = this.getTouches(t)[0], i = this.zoomFactor > 1 ? 1 : this.options.tapZoomFactor,
                        n = this.zoomFactor, s = function (t) {
                    ...
                    var e = (this.zoomFactor - 1) * this.getContainerX(),
                        i = (this.zoomFactor - 1) * this.getContainerY(), n = Math.max(e, 0), s = Math.max(i, 0),
                        o = Math.min(e, 0), a = Math.min(i, 0);
                    ...
                    var t = this.container[0].offsetWidth * this.zoomFactor, e = this.offset.x,
                        ...
                        o = this.container[0].offsetHeight * this.zoomFactor, a = this.offset.y,
                        r = o - a - this.container[0].offsetHeight, l = a / r,
                    ...
                    this.updatePlaned || (this.updatePlaned = !0, setTimeout(function () {
                        ...
                        var t = this.getInitialZoomFactor() * this.zoomFactor, e = -this.offset.x / t,
                            ...
                            s = "scale(" + t + ", " + t + ") translate(" + e + "px," + i + "px)", o = function () {
        ...
        a.DEFAULTS = {
            ...
            if (e && e.length) {
                var i = e.outerWidth(), n = e.outerHeight(), s = e.find(".am-popover-caret"),
                    a = s.outerWidth() / 2 || 8, r = n + 8, l = t.outerWidth(), c = t.outerHeight(), u = t.offset(),
                    h = t[0].getBoundingClientRect(), d = o.height(), p = o.width(), m = 0, f = 0, v = 0, g = 2,
                    w = "top";
                e.css({
                    left: "",
                    top: ""
        ...
        var n = i(2), s = function () {
            ...
            l.configure = function (t) {
                ...
                var n, o = i.querySelector(c.barSelector), a = t ? "-100" : e(l.status || 0),
        ...
        "use strict";
        var n = i(1), s = i(2), o = i(17), a = i(3), r = s.support.animation, l = s.support.transition,
            c = function (t, e) {
        ...
        c.DEFAULTS = {
            ...
            var t = this, e = this.options, i = this.$pureview, s = n([]), o = n([]), a = this.$images, r = a.length;
        ...
        var n = i(1), s = i(2), o = s.utils.rAF, a = s.utils.cancelAF, r = !1, l = function (t, e) {
            ...
            e = e || {};
            var u, h, d, p = n(t), m = parseInt(e.position) || l.DEFAULTS.position, f = p.scrollTop(), v = f, g = m - f,
                w = e.speed || Math.min(750, Math.min(1500, Math.abs(f - m))), y = function () {
                    s()
                };
            if (!r && 0 !== g) {
        ...
        l.DEFAULTS = {
            ...
            var t = this.options, e = [], i = encodeURIComponent(a.title), o = encodeURIComponent(a.location),
                r = "?body=" + i + o;
        ...
        d.prototype.createDefault = function (t) {
            ...
            constructor: o, getModuleCount: function () {
                ...
                for (var t = f.getPatternPosition(this.typeNumber), e = 0; e < t.length; e++) for (var i = 0; i < t.length; i++) {
                    var n = t[e], s = t[i];
                    if (null == this.modules[n][s]) for (var o = -2; 2 >= o; o++) for (var a = -2; 2 >= a; a++) this.modules[n + o][s + a] = -2 == o || 2 == o || -2 == a || 2 == a || 0 == o && 0 == a ? !0 : !1
                }
        ...
        o.DEFAULTS = {
            ...
            var e = this.options, i = this.$window.scrollTop(), n = e.top, s = e.bottom, o = this.$element,
        ...
        function n(t) {
            ...
            return this.each(function () {
                var n = s(this), a = n.is(".am-tabs") && n || n.closest(".am-tabs"), r = a.data("amui.tabs"),
        ...
        c.DEFAULTS = {
            ...
            if (t = "number" == typeof t ? this.$navs.eq(i) : s(t), t && t.length && !this.transitioning && !t.parent("li").hasClass(e)) {
                var n = this.$tabNav, o = t.attr("href"), a = /^#.+$/,
                    r = a.test(o) && this.$content.find(o) || this.$tabPanels.eq(i), l = n.find("." + e + " a")[0],
            ...
            var e = this.activeIndex, i = "next" === t,
        ...
        o.DEFAULTS = {
            ...
            var r = o.attr("pattern") || !1, l = new RegExp(r), c = null, u = null,
            ...
            var d = void 0 !== o.attr("required") && "false" !== o.attr("required"),
                p = parseInt(o.attr("maxlength"), 10), m = parseInt(o.attr("minlength"), 10), f = Number(o.attr("min")),
                v = Number(o.attr("max")), g = this.createValidity({field: o[0], valid: !0});
            ...
            var t = this, e = this.$element, i = this.options, s = e.find(i.allFields), o = [], a = !0, r = [],
                l = n([]), c = [], u = !1;
        ...
        function n() {
            var t = s(".ds-thread"), e = t.parent('[data-am-widget="duoshuo"]').attr("data-ds-short-name"),
        ...
        function s() {
            var t = document.querySelector(".am-map"), e = 116.331398, i = 39.897445, n = t.getAttribute("data-name"),
                s = t.getAttribute("data-address"), o = t.getAttribute("data-longitude") || e,
                a = t.getAttribute("data-latitude") || i, r = t.getAttribute("data-setZoom") || 17,
                l = t.getAttribute("data-icon"), c = new BMap.Map("bd-map"), u = new BMap.Point(o, a);
        ...
        function n() {
            if (s("#mechat").length) {
                var t = s('[data-am-widget="mechat"]'), e = t.data("am-mechat-unitid"),
            ...
            i.find("a").not(".am-parent>a").on("click", function (t) {
                ...
                l.on("click", function () {
                    ...
                    var o, a = n(this).index() > e, l = n(this)[a ? "next" : "prev"](),
                        u = l.offset() || n(this).offset(), h = i.offset(), d = parseInt(i.css("padding-left"));
        ...
        function n() {
            ...
            if (n.length) {
                var l = s(window), c = s("body"), u = n.find(".am-navbar-nav"), h = n.find("li"), d = h.length,
                    p = u.attr("class") && parseInt(u.attr("class").match(/am-avg-sm-(\d+)/)[1]) || 3, m = 60, f = 16,
                    v = h.filter("[data-am-navbar-share]"), g = h.filter("[data-am-navbar-qrcode]"), w = "am-active",
                    y = s('<ul class="am-navbar-actions"></ul>', {id: o.utils.generateGUID("am-navbar-actions")}),
